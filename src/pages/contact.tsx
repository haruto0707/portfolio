...
export const ContactPage = () => {
    const [formData, setFormData] = useState({  // この行を追加
        name: '',
        email: '',
        message: '',
    });  // この行を追加

    const { hasCopied, onCopy } = useClipboard('haruto.0707@outlook.jp');
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch('YOUR_FIREBASE_FUNCTIONS_ENDPOINT/sendEmail', {
                method: 'POST',
                headers: {
                        ...
                        <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                            ...
                            <Stack
                                ...
                                <Stack
                                    ...
                                    <Box as="a" href="https://github.com/haruto0707">
                                        <IconButton
                                            aria-label="github"
                                            variant="ghost"
                                            size="lg"
                                    ...
                                    <Box as="a" href="https://twitter.com/harut1577">
                                        <IconButton
                                            aria-label="twitter"
                                            variant="ghost"
                                            size="lg"
                                    ...
                                    <Box as="a" href="https://www.instagram.com/s_haruto1577/">
                                        <IconButton
                                            aria-label="linkedin"
                                            variant="ghost"
                                            size="lg"
